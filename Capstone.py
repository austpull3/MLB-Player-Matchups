...
def page2():
    ...
    if league == "NL":
        ...
        alteam = st.radio("Select an American League Team.", ('Blue Jays', 'Orioles', 'Ray's, 'Red Sox', 'Yankees', 'Guardians', 'Royals', 'Tigers', 'Twins', 'White Sox', 'Angels', 'Astros', 'Athletics', 'Mariners', 'Rangers'))
        if alteam == "Blue Jays":
